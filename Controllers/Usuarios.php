...
class Usuarios extends Controller
{
            ...
            if ($id_usuario == '') {
                ...
                if (empty($verificarCorreo)) {
                    ...
                    if (empty($verificarTel)) {
                        ...
                        if ($data > 0) {
                            $res = array('tipo' => 'success', 'mensaje' => 'EL USUARIO A SIDO REGISTRADO');
                        } else {
                            $res = array('tipo' => 'error', 'mensaje' => 'NO SE PUDO REGISTRAR');
                        }
                    } else {
                ...
                if (empty($verificarCorreo)) {
                    ...
                    if (empty($verificarTel)) {
                        ...
                        if ($data == 1) {
                            $res = array('tipo' => 'success', 'mensaje' => 'SE USUARIO A SIDO MODIFICADO');
                        } else {
    ...
    public function delete($id)
    {
        ...
        if ($data == 1) {
            ...
            $res = array('tipo' => 'warning', 'mensaje' => 'NO SE PUDO ELIMINAR');
        }
        echo json_encode($res, JSON_UNESCAPED_UNICODE);
        die();
    }
    ...
    {
        $data['title'] = 'PERFIL - DATOS DEL USUARIO';
    ...
    public function cambiarProfile()
    {
        ...
        if (empty($correo) || empty($nombre) || empty($apellido) || empty($telefono) || empty($direccion)) {
            ...
            if ($data == 1) {
                $res = array('tipo' => 'success', 'mensaje' => 'LOS DATOS FUERON MODIFICADOS');
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL MODIFICAR');
            }
        }
