...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo BASE_URL . 'Assets/images/miniatura.ico'; ?>">
...
<!-- LOGIN -->
        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">INGRESE CORREO Y CONTRASEÑA</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="inputReset">ingrese correo de recuperacion</label>
                        <input id="inputReset" class="form-control" type="text" name="inputReset" placeholder="correo@gmail.com">
                    </div>
                </div>
